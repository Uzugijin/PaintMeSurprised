...
bl_info = {
    ...
    "author": "Uzugijin", #with help from Codeium AI
...
class PaintMeSurprised(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(scene, "lock", text="Ready To Record" if context.scene.lock else "Cancel")
    ...
    def execute(self, context):
        if context.scene.lock == False:
            ...
            if (input_text not in bpy.data.images or
                ...
                print("Error: Input image, UV map, or temp image does not exist")
