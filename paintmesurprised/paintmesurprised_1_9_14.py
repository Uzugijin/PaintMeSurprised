...
class PMS_Properties(bpy.types.PropertyGroup):
    ...
    auto_unwrap_enum: bpy.props.EnumProperty(name="Island gap", description="Gap size between uv islands", items=[("0.05", "5", ""),("0.025", "4", ""), ("0.005", "3", ""), ("0.0025", "2", ""), ("0.0005", "1", "")], default="0.05")
