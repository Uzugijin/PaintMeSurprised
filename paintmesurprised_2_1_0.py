...
class PMS_Properties(bpy.types.PropertyGroup):
    ...
    auto_unwrap_algo_enum: bpy.props.EnumProperty(name="Algorithm", description="Unwrap algorithm", items=[("SMART", "Smart UV Projection", ""), ("LIGHTMAP", "Lightmap Pack", "")], default="SMART")
